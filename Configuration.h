...
#define STRING_CONFIG_H_AUTHOR "(akirasan, enero 2020)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 8000, 700 }
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, -30, -3.3}
...
#define Z_SAFE_HOMING
  ...
  //#define Z_SAFE_HOMING_X_POINT X_MIN_POS + 10
  //#define Z_SAFE_HOMING_Y_POINT Y_MIN_POS + 10
#endif

// Homing speeds (mm/m)
#define HOMING_FEEDRATE_XY (50*60)
#define HOMING_FEEDRATE_Z  (8*60)    //akirasan (4*60)
